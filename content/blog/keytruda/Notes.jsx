...
const notes = {
  ...
  4: 'The generic name follows WHO naming conventions: "-mab" indicates a monoclonal antibody, "-zu-" means humanized (derived from human sequences), and "-li-" indicates an immunomodulator.',
}
