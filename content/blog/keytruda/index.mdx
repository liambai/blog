...
date: "2025-12-31"
description: PD-1/PD-L1, immuno-oncology, checkpoint inhibition, binding visualizations, antibody anatomy.
---
import img_PD1_PDL1_with_membranes from "./images/PD1_PDL1_with_membranes.png"
import img_tumor_tcell_interactions from "./images/tumor_tcell_interactions.jpg"
...
<Pd1Pdl1Viewer client:only="react" title="PD-1/PD-L1 interface (PDB 3BIK)" />
...
<Figure>
  <Image slot="content" path={img_PD1_PDL1_with_membranes} />
...
<AlphafoldPd1Viewer client:only="react" title="PD-1 full structure predicted by AF2 (UniProt Q15116)" />
...
<Figure>
  <Image slot="content" path={img_tumor_tcell_interactions} />
...
<Pd1KeytrudaViewer client:only="react" title="PD-1/Keytruda interface (PDB 5B8C)" />
...
<Pd1PoseOverlayViewer client:only="react" title="PD-1 binding PD-L1 vs. Keytruda" />
...
<KeytrudaFullViewer client:only="react" title="Full Keytruda antibody (PDB 5DK3)" />
