...
The Keytruda structure above is a fragment of the overall antibody with its characteristic Y shape. It is called the **variable fragment**, or **Fv**, in contrast with the stem region that tends to be constant.
