...
The extracellular binding domain and the transmembrane helix are predicted with high confidence, while the intracellular tail appears disordered with low confidence. When PD-L1 binds to PD-1, PD-1's intracellular tail triggers a cascade of events leading to the T cell's inactivation.<Note id={3}/>
