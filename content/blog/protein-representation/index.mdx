...
When we need one vector that describes the entire sequence – instead of a vector for each amino acid – we can simply average the values in each vector.
