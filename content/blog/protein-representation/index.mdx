...
<Figure>
  <Image slot="content"
      path="./images/PDB-sequences-vs-structures.png"
      width="70%"
    />
...
<Figure>
  <Image slot="content" path="./images/MLM.png" style={{ marginBottom: 5 }} />
...
<Figure>
  <Image slot="content" path="./images/attention-viz.png" width="80%" />
...
<Figure>
  <Image slot="content" path="./images/UniRep-protein-engineering.png" />
...
<Figure>
  <Image slot="content" path="./images/UniRep-clustering.png" />
...
<Figure>
  <Image slot="content"
      path="./images/UniRep-helix-sheet-neuron.png"
      width="80%"
    />
...
<Figure>
  <Image slot="content" path="./images/attention-contact.png" />
...
<Figure>
  <Image slot="content" path="./images/attention-binding-site.png" />
