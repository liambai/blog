...
<Figure content={<Image path={require("./images/MLM.png")} />} />
...
<Figure content={<Image path={require("./images/architecture.png")} />} />
...
>
  Self-attention visualization of a word-tokenized sentence. Deep blue indicates
...
<Figure content={<Image path={require("./images/attention-contact.png")} />}>
  ...
  acids positions in 3D contact. Deep blue reflects high correlation between
...
>
  ...
  $, i.e. that have attention directed to them. Figure from <Reference id={6} />.
</Figure>
