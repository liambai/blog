...
date: "2023-09-27"
description: Learning protein representations. Transfer learning, representation learning, contextual embeddings, Transformers, masked language modeling, BERT, ESM, attention analysis.
---
...
a labeled training example. In NLP, this approach is called **masked language modeling (MLM)**,
...
the causal instead of masked language modeling objective, predicting amino acids from left to
right.)
...
As it turns out, once we train our model on the masked language modeling objective,
