...
---
import img_PDB_sequences_vs_structures from "./images/PDB-sequences-vs-structures.png"
import img_MLM from "./images/MLM.png"
import img_architecture from "./images/architecture.png"
import img_attention_viz from "./images/attention-viz.png"
import img_UniRep_protein_engineering from "./images/UniRep-protein-engineering.png"
import img_UniRep_clustering from "./images/UniRep-clustering.png"
import img_UniRep_helix_sheet_neuron from "./images/UniRep-helix-sheet-neuron.png"
import img_attention_contact from "./images/attention-contact.png"
import img_attention_binding_site from "./images/attention-binding-site.png"
...
<Figure>
  <Image slot="content"
      path={img_PDB_sequences_vs_structures}
      width="70%"
    />
...
1. Come up with a vector representation of the protein sequence that captures its important features. The vectors are called **contextualized embeddings**. This is no easy task: it's where the heavy lifting happens and will be the subject of this post.
   ...
   <Figure>
     <AminoAcidEmbedding client:visible slot="content" />
...
We talked in a <a href="/protein-evolution">previous post</a> about ways to leverage the information hidden in Multiple Sequence Alignments (MSAs): the co-evolutionary data of proteins.
...
<Figure>
  <AminoAcidEmbeddingEncoder client:visible slot="content" />
...
<Figure>
  <CharacterEmbedding client:visible slot="content" />
...
<Figure>
  <WordEmbedding client:visible slot="content" />
...
<Figure>
  <AminoAcidEmbeddingAverage client:visible slot="content" />
</Figure>
...
<Figure>
  <Image slot="content" path={img_MLM} style={{ marginBottom: 5 }} />
...
<Figure>
  <Image slot="content" path={img_attention_viz} width="80%" />
...
<ol type="a">
  ...
  <li>
    ...
    <a href="/protein-evolution">previous post</a>!)
  </li>
</ol>

<Figure>
  <Image slot="content" path={img_UniRep_protein_engineering} />
...
<Figure>
  <Image slot="content" path={img_UniRep_clustering} />
...
<Figure>
  <Image slot="content"
      path={img_UniRep_helix_sheet_neuron}
      width="80%"
    />
...
<Figure>
  <Image slot="content" path={img_attention_contact} />
...
<Figure>
  <Image slot="content" path={img_attention_binding_site} />
