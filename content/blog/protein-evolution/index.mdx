...
<Figure>
  <Image slot="content" path="./images/sequence-evolution.png" />
...
<Figure>
  <Image slot="content" path="./images/sequence-logo.png" width="90%" />
...
<Figure>
  <Image slot="content" path="./images/potts.png" width="50%" />
...
<Figure>
  <Image slot="content" path="./images/DI-vs-MI.png" width="90%" />
...
<Figure>
  <Image slot="content" path="./images/structures.png" />
...
<Figure>
  <Image slot="content" path="./images/deltaE-mutations.png" />
...
<Figure>
  <Image slot="content" path="./images/deltaE-experimental.png" width="90%" />
...
<Figure>
  <Image slot="content" path="./images/CM-energy.jpeg" width="90%" />
