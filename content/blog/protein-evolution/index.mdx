...
date: "2023-09-16"
description: Using evolutionary information from an Multiple Sequence Alignment (MSA) to predict protein contact and mutation effects.
---
...
<MSACoupling 
  caption="
    The structure on the right sketches how the amino acid chain might fold in space (the nodes
    can be dragged). Hover over each row in the MSA to see the corresponding amino acid in the
