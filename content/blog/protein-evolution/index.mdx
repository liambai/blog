...
A signal hidden in MSAs: amino acid positions that tend to co-vary in the MSA tend to interact with each other in the folded structure, often via direct 3D contact. In the rest of this article, we'll make this idea concrete.
...
<Image
  ...
  caption="
    A sequence logo [generated](https://weblogo.berkeley.edu/logo.cgi) from our MSA. The height of each amino acid indicates its degree of evolutionary conservation.
  "
  width="90%"
/>
