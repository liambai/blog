...
If the KL divergence is $0$, then we have perfectly approximated the posterior.

### Deriving ELBO

If you're not interested in the mathematical details, this section can be skipped entirely. TLDR: expanding out $D_{KL}(q(z | \mathbf{x}) || p(z | \mathbf{x}))$ yields the equation at the end of the section, the foundational equation of variational inference.
