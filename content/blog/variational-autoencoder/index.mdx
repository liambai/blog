...
<Figure>
  <Image slot="content" path="./images/representation.png" width="50%" />
</Figure>
...
<Figure>
  <Image slot="content" path="./images/encoder-decoder-baby.png" width="50%" />
...
<Figure>
  <Image slot="content" path="./images/encoder-decoder-details.png" width="50%" />
...
<Figure>
  <Image slot="content" path="./images/VAE-compression.png" width="60%" />
...
<Figure>
  <Image slot="content" path="./images/standard-normal-transformation.png" />
...
<Figure>
  <Image slot="content" path="./images/MSA-latent.png" />
