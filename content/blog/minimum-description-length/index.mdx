...
<Figure content={<Image path={require("./images/lossless-compression.png")} />}>
  Lossless compression encodes the given text into a compressed representation
  and enables decoding the original text exactly.
