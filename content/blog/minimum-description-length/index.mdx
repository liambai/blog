...
The story of machine learning is one of the repeated failure of our biases, clever tricks, and desire to teach our models the world in the way _we_ see it. In the MDL perspective, each bias we remove is a simplification of the description. The simplest description always wins.
