...
<Figure>
  <Image slot="content" path="./images/monkey-model.png" />
</Figure>
...
<Figure>
  <Image slot="content" path="./images/deepdream-bananas.png" />
...
<Figure>
  <Image slot="content"
      path="./images/interresidue-distance.png"
      width="40%"
      mobileWidth="60%"
    />
...
<Figure>
  <Image slot="content"
      path="./images/interresidue-angles.png"
      width="40%"
      mobileWidth="60%"
    />
...
<Figure>
  <Image slot="content"
      path="./images/trRosetta-architecture.png"
      width="40%"
      mobileWidth="60%"
    />
...
<Figure>
  <Image slot="content" path="./images/hallucination-background.png" />
...
<Figure>
  <Image slot="content" path="./images/hallucination-MCMC-overview.png" />
...
<Figure>
  <Image slot="content" path="./images/hallucination-MCMC-details.png" />
...
<Figure>
  <Image slot="content" path="./images/hallucination-MCMC-progression.png" />
...
<Figure>
  <Image slot="content" path="./images/hallucination-structure-example.png" />
...
<Figure>
  <Image slot="content" path="./images/hallucination-gradients.png" />
...
<Figure>
  <Image slot="content"
      path="./images/enzyme-active-site.png"
      width="60%"
      mobileWidth="85%"
    />
...
<Figure>
  <Image slot="content"
      path="./images/scaffolding-motif.png"
      width="40%"
      mobileWidth="60%"
    />
...
<Figure>
  <Image slot="content"
      path="./images/motif-satisfaction-overview.png"
      width="60%"
      mobileWidth="85%"
    />
...
<Figure>
  <Image slot="content" path="./images/ACE2.png" width="50%" mobileWidth="75%" />
...
<Figure>
  <Image slot="content" path="./images/ACE2-attacked.png" />
...
<Figure>
  <Image slot="content" path="./images/ACE2-designs.png" width="80%" />
