...
An obvious task the monkey can help with is image classification, discriminating images containing bananas from ones that don't. The monkey is a **discriminative model**.
...
>
  ...
  recreating the motif? (motif-satisfaction) <Note id={5} />; 2. look at the
