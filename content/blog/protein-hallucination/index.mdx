...
Here's the architecture of the trRosetta CNN. For our purposes, understanding the details is not as important, as long as we remember that it takes in an MSA and spits out these distances and orientation angles.
