...
<Figure>
  <Image slot="content" path="../variational-autoencoder/images/MSA-latent.png" />
...
<Figure>
  <Image slot="content"
      path="../variational-autoencoder/images/VAE-compression.png"
      width="60%"
    />
...
<Figure>
  <Image slot="content"
      path="./images/protein-vae-architecture.png"
      width="90%"
    />
</Figure>
...
<Figure>
  <Image slot="content" path="./images/mutation-effect-heatmap.png" />
...
<Figure>
  <Image slot="content" path="./images/EVE-ClinVar.png" />
...
<Figure>
  <Image slot="content" path="./images/EVEScape.png" />
...
<Figure>
  <Image slot="content" path="./images/EVEScape-timeline.png" />
...
<Figure>
  <Image slot="content" path="./images/DeepSequence-vs-others.png" />
...
<Figure>
  <Image slot="content" path="./images/DeepSequence-vs-independent.png" />
...
<Figure>
  <Image slot="content" path="./images/filter.png" />
</Figure>
...
<Figure>
  <Image slot="content" path="./images/sobel-vs-scharr.png" />
</Figure>
...
<Figure>
  <Image slot="content"
      path="./images/learned-filter.png"
      width="40%"
      mobileWidth="50%"
    />
