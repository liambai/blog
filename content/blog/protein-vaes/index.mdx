...
---
import img_binding_site from "./images/binding-site.png"
import img_spoons from "./images/spoons.png"
import img_MSA_latent from "../variational-autoencoder/images/MSA-latent.png"
import img_VAE_compression from "../variational-autoencoder/images/VAE-compression.png"
import img_protein_vae_architecture from "./images/protein-vae-architecture.png"
import img_mutation_effect_heatmap from "./images/mutation-effect-heatmap.png"
import img_EVE_ClinVar from "./images/EVE-ClinVar.png"
import img_EVEScape from "./images/EVEScape.png"
import img_EVEScape_timeline from "./images/EVEScape-timeline.png"
import img_DeepSequence_vs_others from "./images/DeepSequence-vs-others.png"
import img_DeepSequence_vs_independent from "./images/DeepSequence-vs-independent.png"
import img_filter from "./images/filter.png"
import img_sobel_vs_scharr from "./images/sobel-vs-scharr.png"
import img_learned_filter from "./images/learned-filter.png"
...
<Figure>
  <MSACoupling client:visible slot="content" />
...
<Figure>
  <Image slot="content" path={img_MSA_latent} />
...
The tension between these two rules – and the need to balance them – is a common theme in machine learning. For VAEs, they define the two terms of the <a href="/variational-autoencoder/#the-loss-function">loss function</a> we use while training.

<Figure>
  <Image slot="content"
      path={img_VAE_compression}
      width="60%"
    />
...
<Figure>
  <Image slot="content"
      path={img_protein_vae_architecture}
      width="90%"
    />
</Figure>
...
<Figure>
  <Image slot="content" path={img_mutation_effect_heatmap} />
...
<Figure>
  <Image slot="content" path={img_EVE_ClinVar} />
...
<Figure>
  <Image slot="content" path={img_EVEScape} />
...
<Figure>
  <Image slot="content" path={img_EVEScape_timeline} />
...
Compared to the independent and pair-wise statistical models from a <a href="/protein-evolution">previous post</a>, VAEs are much more accurate.

<Figure>
  <Image slot="content" path={img_DeepSequence_vs_others} />
...
<Figure>
  <Image slot="content" path={img_DeepSequence_vs_independent} />
...
Here's one way to look at these results. MSAs contain a wealth of information, some of which we can understand through simple statistics: <a href="/protein-evolution/#counting-amino-acid-frequencies">position-wise frequencies</a>, <a href="/protein-evolution/#pairwise-frequencies">pair-wise frequencies</a>, etc. Those models are interpretable but limiting – they fail at teasing out more complex, higher-order signals.
...
<Figure>
  <Image slot="content" path={img_filter} />
</Figure>
...
<Figure>
  <Image slot="content" path={img_sobel_vs_scharr} />
</Figure>
